...
using ISuperHeroService = DotNet7_CRUD.Services.SuperHeroService.ISuperHeroService;

namespace DotNet7_CRUD.Controllers
{
    ...
    public class SuperHeroController : ControllerBase
    {
        ...
        public async Task<ActionResult<SuperHero>> GetSingleHero(int id)
        {
            ...
            if (result is null)
            {
                return NotFound("Sorry, but this hero doess't exist. ");
            }
            return Ok(result);
        }
